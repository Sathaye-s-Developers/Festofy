...
const InterCollege_Events = () => {
    ...
    const EventFetcher = async () => {
        try {
            const response = await api.get("/Festofy/user/event/explore", {}, { withCredentials: true, })
    ...
    return (
        <div className='bg-black min-h-screen'>
            ...
            <div className='mt-5'>
                <div>
                    <p className='mt-10 text-center md:text-5xl text-3xl bg-gradient-to-r from-cyan-700 via-teal-500 to-white font-serif bg-clip-text text-transparent font-bold leading-tight'>Intercollege Fests & Competitions</p>
                    <p className='pl-3 mt-5 text-xl md:text-3xl text-white text-center'><span className='font-bold bg-gradient-to-r from-pink-500 to-red-500 bg-clip-text text-transparent'>Compete </span><span className='font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent'>• Connect </span><span className='font-bold bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent'>• Conquer</span></p>
                </div>
            </div>
            <div className="min-h-screen pt-14 pb-16 px-6">
